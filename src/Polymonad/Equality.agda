...
module Polymonad.Equality where
...
abstract
  polymonad-eq : {ℓ : Level} {TyCons : Set ℓ} {Id : TyCons}
               ...
               → (eqId : law-id₁ ≅ law-id₂)
               → (eqFun1 : (λ M → lawFunctor1₁ M) ≅ lawFunctor1₂)
               ...
               → polymonad {l = ℓ} {TyCons = TyCons} {Id = Id} B[_,_]▷₁_ ⟨_⟩₁ bind₁ law-id₁ lawFunctor1₁ lawFunctor2₁ lawMorph1₁ lawMorph2₁ lawMorph3₁ lawDiamond1₁ lawDiamond2₁ law-assoc₁ lawClosure₁ 
               ≡ polymonad {l = ℓ} {TyCons = TyCons} {Id = Id} B[_,_]▷₂_ ⟨_⟩₂ bind₂ law-id₂ lawFunctor1₂ lawFunctor2₂ lawMorph1₂ lawMorph2₂ lawMorph3₂ lawDiamond1₂ lawDiamond2₂ law-assoc₂ lawClosure₂ 
  polymonad-eq {ℓ} {TyCons} {Id} {B[_,_]▷_} {.B[_,_]▷_} {⟨_⟩} {.⟨_⟩} {b} {.b} 
               {lid} {.lid} {fun1} {.fun1} {fun2₁} {fun2₂} {mor1} {.mor1} {mor2} {.mor2} {mor3₁} {mor3₂} {dia1} {.dia1} {dia2} {.dia2} {ass₁} {ass₂} {clo} {.clo} 
               refl refl hrefl hrefl hrefl hrefl hrefl hrefl hrefl hrefl
    = cong₃ (λ fun2 mor3 ass → polymonad {l = ℓ} {TyCons = TyCons} {Id = Id} (B[_,_]▷_) (⟨_⟩) b lid fun1 fun2 mor1 mor2 mor3 dia1 dia2 ass clo) p1 p2 p3
    where
      abstract
        p1 : (λ M b {α} m → fun2₁ M b {α} m) ≡ (λ M b {α} m → fun2₂ M b {α} m)
        p1 = fun-ext 
           $ λ M → fun-ext 
           $ λ b → implicit-fun-ext 
           $ λ α → fun-ext 
           $ λ m → proof-irrelevance (fun2₁ M b m) (fun2₂ M b m)
