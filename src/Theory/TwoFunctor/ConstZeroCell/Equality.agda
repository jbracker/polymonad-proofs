...
abstract
  const-lax-two-functor-eq : {ℓC₀ ℓC₁ ℓC₂ ℓD₀ ℓD₁ ℓD₂ : Level} 
                           ...
                           → {μ₁ : {x y z : Cell₀ C} {f : Cell₁ C x y} {g : Cell₁ C y z} → Cell₂ D (_∘_ D ([ P₁₁ ]₀ g) ([ P₁₁ ]₀ f)) ([ P₁₁ ]₀ (_∘_ C g f))}
                           → {lfi₁₀ : {x y : Cell₀ C} {f : Cell₁ C x y}
                                    → (_∘ᵥ_ D (μ₀ {x} {x} {y} {id₁ C {x}} {f}) (_∘ₕ_ D (id₂ D {f = [ P₁₀ {x} {y} ]₀ f}) (η₀ {x})) ) 
                                    ≅ id₂ D {f = [ P₁₀ {x} {y} ]₀ f}}
                           → {lfi₁₁ : {x y : Cell₀ C} {f : Cell₁ C x y} 
                                    → (_∘ᵥ_ D (μ₁ {x} {x} {y} {id₁ C {x}} {f}) (_∘ₕ_ D (id₂ D {f = [ P₁₁ {x} {y} ]₀ f}) (η₁ {x})) ) 
                                    ≅ id₂ D {f = [ P₁₁ {x} {y} ]₀ f}}
                           → {lfi₂₀ : {x y : Cell₀ C} {f : Cell₁ C x y} 
                                    → (_∘ᵥ_ D (μ₀ {x} {y} {y} {f} {id₁ C {y}}) (_∘ₕ_ D (η₀ {y}) (id₂ D {f = [ P₁₀ {x} {y} ]₀ f})) ) 
                                    ≅ id₂ D {f = [ P₁₀ {x} {y} ]₀ f}}
                           → {lfi₂₁ : {x y : Cell₀ C} {f : Cell₁ C x y} 
                                    → (_∘ᵥ_ D (μ₁ {x} {y} {y} {f} {id₁ C {y}}) (_∘ₕ_ D (η₁ {y}) (id₂ D {f = [ P₁₁ {x} {y} ]₀ f})) ) 
                                    ≅ id₂ D {f = [ P₁₁ {x} {y} ]₀ f}}
                           → {la₀ : {w x y z : Cell₀ C} {f : Cell₁ C w x} {g : Cell₁ C x y} {h : Cell₁ C y z} 
                                  → (_∘ᵥ_ D (μ₀ {w} {y} {z} {_∘_ C g f} {h}) (_∘ₕ_ D (id₂ D {constD} {constD} {[ P₁₀ {y} {z} ]₀ h}) (μ₀ {w} {x} {y} {f} {g})) ) 
                                  ≅ _∘ᵥ_ D (μ₀ {w} {x} {z} {f} {_∘_ C h g}) 
                                           (_∘ₕ_ D (μ₀ {x} {y} {z} {g} {h}) (id₂ D {constD} {constD} {[ P₁₀ {w} {x} ]₀ f}))}
                           → {la₁ : {w x y z : Cell₀ C} {f : Cell₁ C w x} {g : Cell₁ C x y} {h : Cell₁ C y z} 
                                  → (_∘ᵥ_ D (μ₁ {w} {y} {z} {_∘_ C g f} {h}) (_∘ₕ_ D (id₂ D {constD} {constD} {[ P₁₁ {y} {z} ]₀ h}) (μ₁ {w} {x} {y} {f} {g})) ) 
                                  ≅ _∘ᵥ_ D (μ₁ {w} {x} {z} {f} {_∘_ C h g}) 
                                           (_∘ₕ_ D (μ₁ {x} {y} {z} {g} {h}) (id₂ D {constD} {constD} {[ P₁₁ {w} {x} ]₀ f}))}
